...
class SodiumSupplyNASEM2021(KnowledgeEquation):
    """Absorbed sodium supply from the diet (NASEM 2021, Eq. 20-407/20-408)."""

    name = "Absorbed sodium (Na) supply from the diet"
    citation = Citation(publication=NASEM_DAIRY_2021, chapter="6/20", equation_number="Equations 20-407, 20-408")
    variables = [
        Variable(symbol="Fd_NaInf", name="Sodium intake per ingredient", unit="g/d"),
        Variable(symbol="Fd_acNaf", name="Absorption coefficient per ingredient", unit="g/g"),
    ]
